...
Para gerir o estado do jogo de forma eficiente e cumprir os requisitos de memória, foram utilizadas as seguintes estruturas2:
...
*   **Dicionário de Defesa:** Uma lista de registos (records) ou mapas onde cada entrada representa um barco da frota444. Cada barco contém:
    ...
    *   **Células Vivas:** Uma lista de coordenadas (int \* int) que ainda não foram atingidas6.
        
    *   **Estado:** Booleano indicando se o barco já foi afundado7.
        

### Estado da IA

*   **Fila de Alvos (target\_queue):** Uma lista de coordenadas prioritárias para o **Modo Caça**8.
...
A inteligência do agente divide-se em três estados principais para otimizar a destruição da frota adversária12:

### Modo Busca (Default)

Enquanto não encontra barcos, o agente dispara em células desconhecidas seguindo um padrão de "paridade" (como um tabuleiro de xadrez). Isto reduz o número de tiros necessários para encontrar barcos lineares, que ocupam pelo menos 2 células13131313.


### Modo "Caça" (Requisito Mínimo)

Ao receber a resposta tiro , o agente ativa este modo14:
...
Se o agente obtiver dois acertos num barco (ex: duas vezes tiro fragata), a IA analisa a geometria17:

1.  **Inferência de Orientação:** Se as linhas são iguais, o barco é **horizontal**; se as colunas são iguais, é **vertical**18.
    
2.  **Foco Linear:** O agente descarta alvos adjacentes que saiam dessa linha/coluna e foca-se em disparar nas extremidades dos acertos conhecidos até receber a mensagem afundado19.
